# Module 5: Legislative Terminology and Language

!!! info inline end "Progress"
Module 5 of 6 • 2-3 hours
...
- Identify voting terminology
- Use common legislative abbreviations correctly
- Interpret phrases you'll hear during Senate sessions
- Apply terminology in practice scenarios
...
- **Avoid errors** from misunderstanding terms

**This module is your dictionary** for the legislative world.
...
**Usage:** "SB 445" or "House Bill 1022"  
**Key Point:** Number tells you which chamber it started in
...
**Usage:** "Senate Resolution 45" or "SR 45"  
**Key Point:** Resolutions ≠ bills. They don't become Public Acts.
...
**Usage:** "The Senate is in session" or "The 2025-2026 session"
...
- **HB** = House Bill
- **PA** = Public Act
- **MCL** = Michigan Compiled Law (state statutes)
...
- **GO** = General Orders (Committee of the Whole)
- **IE** = Immediate Effect
- **1st** = First Reading
- **2nd** = Second Reading (General Orders)
- **3rd** = Third Reading
...
- **TRANS** = Transportation Committee
...
- "And refers the bill to the Committee on [name]"
...
- "Without objection, the bill is advanced to Third Reading"
...
- "Yeas [number], Nays [number], Excused [number], Not Voting [number]"
...
- "The question being on concurrence in the House amendments"
- "The Senate concurs" / "The Senate non-concurs"
...
- "I move the Senate adopt the conference report"
...
<details>
<summary>Answer</summary>
**Defeated** or **Failed** (needs 20 votes to pass)
</details>
...
<details>
<summary>Answer</summary>
**Co-sponsor** (Johnson is the sponsor)
</details>
...
<details>
<summary>Answer</summary>
**Denied** (needs 26 votes; only got 24)
</details>
...
<details>
<summary>Answer</summary>
**Referred to Another Committee** or **Multiple Referral**
</details>
...
<details>
<summary>Answer</summary>
**Adopted** or **Adopted by Voice Vote** (if voice vote) or **Adopted by Roll Call** (if roll call)
</details>
...
A: Core terms (bill, SB, PA, passed, referred, GO, Third Reading, IE, concur) are essential. Others you'll learn through repetition. Focus on terms you'll hear most often during sessions.

**Q: What if I hear a term I don't recognize during a live session?**  
A: Flag it and ask your supervisor after the immediate action is coded. Don't let unfamiliar terms stop you from coding what you do understand.

**Q: Are there regional variations in terminology?**  
A: Some terms vary between states, but within Michigan, terminology is standardized. Always use Michigan's official terms.

**Q: How can I practice terminology?**  
A: Read the Senate Journal, watch archived sessions, and complete the practice scenarios in this course. Repetition is key.

---

## Key Takeaways

✅ Legislative language is precise and formal  
✅ Bill = proposed law; PA = enacted law  
✅ SB = Senate Bill; HB = House Bill  
✅ Know bill status terms: introduced, referred, reported, passed, enrolled  
